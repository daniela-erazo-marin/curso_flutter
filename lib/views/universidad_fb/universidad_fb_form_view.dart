import 'package:curso_flutter/models/universidad_fb.dart';
import 'package:curso_flutter/services/universidades_service.dart';
...
class _UniversidadFbFormViewState extends State<UniversidadFbFormView> {
  ...
  final _pagina_webController = TextEditingController();
    ...
    if (_formKey.currentState!.validate()) {
      try {
        final universidad = UniversidadFb(
          ...
          pagina_web:  _pagina_webController.text.trim(),

        );

        if (widget.id == null) {
          await UniversidadesService.addUniversidad(universidad);
        } else {
          await UniversidadesService.updateUniversidad(universidad);
        }
  ...
  void _inicializarCampos(UniversidadFb universidad) {
    ...
    _nitController.text = universidad.nombre;
    ...
    _pagina_webController.text = universidad.pagina_web;
                        ...
                        TextFormField(
                          ...
                          validator: (value) {
                            ...
                            if (value.trim().length < 11) {
                              return 'El nit debe tener al menos 11 caracteres';
                            }
                            return null;
                          },
                        ),
                        ...
                        TextFormField(
                          ...
                          validator: (value) {
                            ...
                            if (value.trim().length < 15) {
                              return 'La direccion debe tener al menos 15 caracteres';
                            }
                            return null;
                          },
                        ),
                        ...
                        TextFormField(
                          ...
                          validator: (value) {
                            ...
                            if (value.trim().length < 13) {
                              return 'El telefono debe tener al menos 13 caracteres';
                            }
                            return null;
                          },
                        ),
